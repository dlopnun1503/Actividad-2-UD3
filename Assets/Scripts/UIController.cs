...
public class UIController : MonoBehaviour {
    ...
    public void FindAllItems()
    {
        ...
        XmlNodeList items = itemDataXml.SelectNodes("/ItemsInventario/ItemsInventario");
    ...
    public void FindItemsOfType(string itemType)
    {
        ...
        XmlNodeList items = itemDataXml.SelectNodes("/ItemsInventario/ItemsInventario[@Type='" + itemType + "']");
    ...
    {
        XmlNode curNode = itemDataXml.SelectSingleNode("/ItemsInventario/ItemsInventario[@ID='" + itemID + "']");
        if (curNode == null)
        {
